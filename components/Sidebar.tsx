   ...
   return (
    <div>
        ...
        <p className="px-2 py-1 my-3 bg-gray-200 dark:bg-black-200 rounded-full">Web Developer</p>
         <a className="flex items-center justify-center px-2 py-1 my-3 bg-gray-200 dark:bg-black-200 rounded-full" href="/assets/Md_Hasnine_Sheak_CV.pdf" download="resume.pdf"  ><GiTie className="w-6 h-6"/> <span>Download Resume</span>
         </a>
        {/* Social icons */}
