  ...
  return (
    <ThemeProvider attribute="class">
      <div className="grid grid-cols-12 gap-6 px-5 mt-4 md:mt-14 mb-14 lg:px-48 sm:px-20 md:px-32">
        ...
        <div className="flex flex-col col-span-12 bg-white dark:bg-black-500 lg:col-span-9 rounded-2xl overflow-hidden shadow-custom-light dark:shadow-custom-dark">
          <Navbar />
